...
def _write_falconkv_config(client_cfg: dict, test_cfg: dict, config: dict,
    ...
    falconkv_cfg = {
        ...
        "store": {
            ...
            "hixl_engine_host": client_cfg.get("hixl_engine_host", ""),
            "hixl_base_port": client_cfg.get("hixl_base_port", 16000),
            "hixl_engine_addr": client_cfg.get("store_hixl_engine_addr", ""),
            "hixl_device_id": client_cfg.get("store_hixl_device_id", -1),
        },
        "client": {
            "cache_capacity": client_cfg.get("cache_capacity", 100000),
            "hixl_engine_host": client_cfg.get("client_hixl_engine_host", ""),
            "hixl_base_port": client_cfg.get("client_hixl_base_port", 17000),
            "hixl_engine_addr": client_cfg.get("client_hixl_engine_addr", ""),
            "hixl_device_id": client_cfg.get("client_hixl_device_id", -1),
        },
        "transfer": {
            "meta_addr": meta_addr,
            "remote_read_transport": transfer_cfg.get("remote_read_transport", "brpc"),
            ...
            "hixl_protocol_desc": transfer_cfg.get("hixl_protocol_desc", ""),
            "hixl_local_comm_res": transfer_cfg.get("hixl_local_comm_res", ""),
            "hixl_mem_type": transfer_cfg.get("hixl_mem_type", "host"),
            "hixl_staging_chunk_size_mb": transfer_cfg.get("hixl_staging_chunk_size_mb", 16),
            "hixl_staging_chunk_count": transfer_cfg.get("hixl_staging_chunk_count", 16),
            "hixl_receive_chunk_size_mb": transfer_cfg.get("hixl_receive_chunk_size_mb", 16),
            "hixl_receive_chunk_count": transfer_cfg.get("hixl_receive_chunk_count", 16),
            "hixl_transfer_timeout_ms": transfer_cfg.get("hixl_transfer_timeout_ms", 5000),
            "hixl_connect_timeout_ms": transfer_cfg.get("hixl_connect_timeout_ms", 3000),
            "hixl_min_read_size_bytes": transfer_cfg.get("hixl_min_read_size_bytes", 1048576),
            "hixl_fallback_to_brpc": transfer_cfg.get("hixl_fallback_to_brpc", True),
        },
    }
